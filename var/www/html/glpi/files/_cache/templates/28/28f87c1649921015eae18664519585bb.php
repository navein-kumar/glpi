...
class __TwigTemplate_b5936415e18d189029e9349b67f3822b extends Template
{
    private $source;
    private $macros = [];
        ...
        if ((array_key_exists("item_ticket", $context) &&  !(null === ($context["item_ticket"] ?? null)))) {
         ...
         <div id=\"items\" class=\"accordion-collapse collapse ";
            ...
            <div class=\"accordion-body accordion-items row m-0 mt-n2\">
               ";
            // line 289
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["item_ticket"] ?? null), "itemAddForm", [($context["item"] ?? null), ((array_key_exists("params", $context)) ? (_twig_default_filter(($context["params"] ?? null), [])) : ([]))], "method", false, false, false, 289), "html", null, true);
            echo "
            </div>
         </div>
      </div>
